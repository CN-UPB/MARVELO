...
1. [example_1](#first-example), first configuration
2. [example_2](#second-example), interactive + multiple Inputs/Outputs + ExecutableJob
3. [example_3](#third-example), interactive with default value and Buffer
4. [example_4](#fourth-example), head in Job
