...
while n < 505599 - 5 * 8192:
    ...
    coherence2 = np.fromfile(input[4], dtype='i2', count=8192)#CW_Block2.process_data(delay_DataBlock1_buf, delay_DataBlock2_buf)
    ...
    coherenceDrift = CoherenceDriftEstimator_Block.process_data(coherence1, coherence22)
